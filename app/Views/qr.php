...
<head>
  ...
  <title>E-Ticket | My Little Island School</title>
  ...
  <style>
    ...
    /* The Fix: Elegant Background Watermark Inside the Ticket */
    .ticket-watermark {
      position: absolute;
      top: 50%;
      left: 50%;
    ...
    /* Authentic Ticket Side Cutouts (Left & Right Punch Holes) */
    .ticket-card::before,
    .ticket-card::after {
      content: '';
      position: absolute;
      ...
      width: 30px;
      height: 30px;
      background: rgb(6, 15, 41); /* Matches outer body background */
      border-radius: 50%;
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10 col-xl-9">
        ...
        <div class="ticket-card">
          ...
          <!-- Invisible Watermark Layer Behind Text -->
          <div class="ticket-watermark"></div>
          
          <!-- Clear Content Layer On Top -->
            ...
            <div class="row pt-2 align-items-center">
              ...
              <div class="col-md-7 pe-md-4">
                ...
                <div>
                  ...
                  <div class="info-value text-wrap">My Little Island School - Primary Graduation Reception 2026</div>
                </div>
